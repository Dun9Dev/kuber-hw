...
На одном скриншоте зафиксированы все ключевые моменты:
- ✅ Создание namespace и deployment'ов
- ✅ Создание сервисов
- ✅ Проверка доступа без политик
- ✅ Применение сетевых политик
- ✅ Проверка разрешённого трафика (frontend→backend, backend→cache)
- ✅ Проверка запрещённого трафика (frontend→cache, cache→backend) — таймауты
